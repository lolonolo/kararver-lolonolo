...
{ 
  ...
  options: [
    { text: "Acil Durum ve Afet Yönetimi (Önlisans)", value: "acil-durum-ve-afet-yonetimi-onlisans" },
    { text: "Adalet (Önlisans)", value: "adalet-onlisans" },
    { text: "Bankacılık ve Sigortacılık (Önlisans)", value: "bankacilik-ve-sigortacilik-onlisans" },
    { text: "Bilgisayar Programcılığı (Önlisans)", value: "bilgisayar-programciligi-onlisans" },
    { text: "Coğrafi Bilgi Sistemleri (Önlisans)", value: "cografi-bilgi-sistemleri-onlisans" },
    { text: "Çocuk Gelişimi (Önlisans)", value: "cocuk-gelisimi-onlisans" },
    { text: "Dış Ticaret (Önlisans)", value: "dis-ticaret-onlisans" },
    { text: "Elektrik Enerjisi Üretim, İletim ve Dağıtımı (Önlisans)", value: "elektrik-enerjisi-uretim-iletim-dagitimi-onlisans" },
    { text: "Fotoğrafçılık ve Kameramanlık (Önlisans)", value: "fotografcilik-ve-kameramanlik-onlisans" },
    { text: "Grafik Tasarımı (Önlisans)", value: "grafik-tasarimi-onlisans" },
    { text: "Halkla İlişkiler ve Tanıtım (Önlisans)", value: "halkla-iliskiler-ve-tanitim-onlisans" },
    { text: "İlahiyat (Önlisans)", value: "ilahiyat-onlisans" },
    { text: "İnsan Kaynakları Yönetimi (Önlisans)", value: "insan-kaynaklari-yonetimi-onlisans" },
    { text: "İşletme Yönetimi (Önlisans)", value: "isletme-yonetimi-onlisans" },
    { text: "Laborant ve Veteriner Sağlık (Önlisans)", value: "laborant-ve-veteriner-saglik-onlisans" },
    { text: "Lojistik (Önlisans)", value: "lojistik-onlisans" },
    { text: "Menkul Kıymetler ve Sermaye Piyasası (Önlisans)", value: "menkul-kiymetler-ve-sermaye-piyasasi-onlisans" },
    { text: "Muhasebe ve Vergi Uygulamaları (Önlisans)", value: "muhasebe-ve-vergi-uygulamalari-onlisans" },
    { text: "Özel Güvenlik ve Koruma (Önlisans)", value: "ozel-guvenlik-ve-koruma-onlisans" },
    { text: "Perakende Satış ve Mağaza Yönetimi (Önlisans)", value: "perakende-satis-ve-magaza-yonetimi-onlisans" },
    { text: "Radyo ve Televizyon Programcılığı (Önlisans)", value: "radyo-ve-televizyon-programciligi-onlisans" },
    { text: "Sağlık Kurumları İşletmeciliği (Önlisans)", value: "saglik-kurumlari-isletmeciligi-onlisans" },
    { text: "Sosyal Hizmetler (Önlisans)", value: "sosyal-hizmetler-onlisans" },
    { text: "Tarım (Önlisans)", value: "tarim-onlisans" },
    { text: "Tıbbi Dokümantasyon ve Sekreterlik (Önlisans)", value: "tibbi-dokumantasyon-ve-sekreterlik-onlisans" },
    { text: "Turizm ve Otel İşletmeciliği (Önlisans)", value: "turizm-ve-otel-isletmeciligi-onlisans" },
    { text: "Web Tasarımı ve Kodlama (Önlisans)", value: "web-tasarimi-ve-kodlama-onlisans" },
    { text: "Yönetim Bilişim Sistemleri (Lisans)", value: "yonetim-bilisim-sistemleri-lisans" },
    { text: "İşletme (Lisans)", value: "isletme-lisans" },
    { text: "İktisat (Lisans)", value: "iktisat-lisans" },
    { text: "Kamu Yönetimi (Lisans)", value: "kamu-yonetimi-lisans" },
    { text: "Maliye (Lisans)", value: "maliye-lisans" },
    { text: "Uluslararası İlişkiler (Lisans)", value: "uluslararasi-iliskiler-lisans" },
    { text: "Sosyoloji (Lisans)", value: "sosyoloji-lisans" },
    { text: "Tarih (Lisans)", value: "tarih-lisans" },
    { text: "Türk Dili ve Edebiyatı (Lisans)", value: "turk-dili-ve-edebiyati-lisans" }
    ], 
    next: () => null
},
