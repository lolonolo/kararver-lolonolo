document.addEventListener('DOMContentLoaded', () => {
    ...
    const questionsByProfile = {
        lise: [
            ...
            { question: "Bir sorunu çözerken hangi yönün daha ağır basar?", key: "yaklasim_tarzi", options: [ { text: "Analitik düşünür, verileri ve mantığı kullanırım.", value: "analitik" }, { text: "Yaratıcılığımı ve hayal gücüümü kullanırım.", value: "yaratici" }, { text: "Empati kurar, insan odaklı çözümler üretirim.", value: "empati" } ] }
        ],
        universite: [
