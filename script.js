document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizData = {
        lise: [
            ...
            { id: 'acikogretim_universiteleri', question: "Harika! Peki hangi Açıköğretim Fakültesi ile daha çok ilgileniyorsun?", key: "acik-ogretim-okullari", info: "💡 Her üniversitenin kendine özgü bölümleri ve sistemleri olabilir.", options: [ { text: "Anadolu Üniversitesi (AÖF)", value: "anadolu" }, { text: "İstanbul Üniversitesi (AUZEF)", value: "auzef" }, { text: "Atatürk Üniversitesi (ATA-AÖF)", value: "ata-aof" } ], next: () => 'holland_test_1' },
